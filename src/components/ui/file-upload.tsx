...
export const FileUpload = ({
	...
	return (
		<div
			className="w-full rounded-xl border-2 border-purple-950"
			{...getRootProps()}
		>
			<motion.div
				onClick={handleClick}
					...
					return (
						<div
							...
							className={`flex h-10 w-10 shrink-0 rounded-[2px] ${
								index % 2 === 0
									? "bg-gray-50 dark:bg-purple-950"
									: "bg-gray-50 shadow-[0px_0px_1px_3px_rgba(255,255,255,1)_inset] dark:bg-purple-950 dark:shadow-[0px_0px_1px_3px_rgba(0,0,0,1)_inset]"
							}`}
						/>
					);
				}),
